...
fun SettingsPage(navController: NavController) {
    ...
    val exportLauncher =
        rememberLauncherForActivityResult(ActivityResultContracts.CreateDocument("application/json")) { uri ->
            if (uri != null) {
                settingsViewModel.exportSubscriptionCards(uri)
            }
        }
    val importLauncher =
        rememberLauncherForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            if (uri != null) {
                settingsViewModel.importSubscriptionCards(uri)
            }
        }
        ...
        LazyColumn(
            ...
            item {
                Card(
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ListItem(
                            headlineContent = { Text(stringResource(R.string.settings_export_cards)) },
                            supportingContent = { Text(stringResource(R.string.settings_export_cards_description)) },
                            modifier = Modifier.clickable {
                                exportLauncher.launch("aiot-device-config.json")
                            },
                            colors = ListItemDefaults.colors(containerColor = androidx.compose.ui.graphics.Color.Transparent),
                        )
                        ...
                        ListItem(
                            headlineContent = { Text(stringResource(R.string.settings_import_cards)) },
                            supportingContent = { Text(stringResource(R.string.settings_import_cards_description)) },
                            modifier = Modifier.clickable {
